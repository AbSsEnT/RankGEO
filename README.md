...
Run both in separate terminals, then open http://localhost:3000. Enter a website URL, run analysis, then use “Get GEO score” to see the visibility score and related prompts.
